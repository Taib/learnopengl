...
class Mesh {
public:
	Mesh(const float* vertices, const unsigned int* indices, unsigned int numVertices, unsigned int numIndices);
	~Mesh();
	void draw();
private:
	unsigned int VBO;
...
Mesh::Mesh(const float* vertices, const unsigned int* indices, unsigned int numVertices, unsigned int numIndices)
{
